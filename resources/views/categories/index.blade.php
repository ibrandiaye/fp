                            ...
                            <div class="card-body">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="panel-heading">Page {{ $categories->currentPage() }} of {{ $categories->lastPage() }}
                                        <a href="{{route('categorie.create') }}" class="btn btn-info float-right" style="margin-right: 3px;"><i class="fas fa-plus"></i></a></div>
                                            ...
                                            @foreach ($categories as $categorie)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ URL::to('categorie/'.$categorie->id.'/edit') }}" class="btn btn-warning pull-left" ><i class="far fa-edit"></i></a>
